...
with open(settings_path, 'r') as f:
    ...
    raw_tweets_dump_path = current_run_dir + str(version) + 'dump.txt'
    raw_tweets_batch_path = current_run_dir + str(version) + 'batch.txt'
...
logging.info('Original Start Times, with lang and public metrics.')
